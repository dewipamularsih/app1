...
<head>
    ...
    <title><?= $title ?> | BERKAH QURBAN</title>
    <!-- BEGIN: CSS Assets-->
    ...
    <div class="top-bar-boxed h-[70px] z-[51] relative border-b border-white/[0.08] mt-12 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
        <div class="h-full flex items-center">
            ...
            <a href="" class="-intro-x hidden md:flex">
                <img alt="Midone - HTML Admin Template" class="w-6" src="<?= site_url('asset') ?>/admin/dist/images/logo.svg">
                <span class="text-white text-lg ml-3"> BERKAH QURBAN </span>
            </a>
            <!-- END: Logo -->
            <!-- BEGIN: Breadcrumb -->
            ...
            <div class="intro-x dropdown w-8 h-8">
                ...
                <div class="dropdown-menu w-56">
                    <ul class="dropdown-content bg-primary/80 before:block before:absolute before:bg-black before:inset-0 before:rounded-md before:z-[-1] text-white">
                        ...
                        <!-- <li>
                            <a href="<?= site_url('profile_admin') ?>" class="dropdown-item hover:bg-white/5"> <i data-lucide="user" class="w-4 h-4 mr-2"></i> My Profile </a>
                        </li>
                        <li>
        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= site_url('admin/dashboard') ?>" class="side-menu">
                    ...
                    <!-- <li>
                        <a href="<?= base_url('profile_admin') ?>" class="side-menu">
